...
path = "//uio/lagringshotell/geofag/students/metos/hannasv"
...
for season, season_list in seasons.items():
    for climate_zone, cz in climate_zones.items():
        for key, value in available_years.items():
            ...
            files = glob.glob(path+"/dataERA5/*rh.nc")
            if path+"/dataERA5/"+season+"_"+climate_zone+"_"+key+'_rh.nc' in files:
                print(path+"/dataERA5/"+season+"_"+climate_zone+"_"+key+'_rh.nc is downloaded')
                counter += 1
                ...
                c.retrieve(
                    'reanalysis-era5-pressure-levels', # reanalysis-era5-single-levels
                    {
                        ...
                        'variable':'relative_humidity', # specific_humidity, '2m_temperature','surface_pressure','total_cloud_cover'
                        'time':[
                    ...
                    path+"/dataERA5_grib/"+season+"_"+climate_zone+"_"+key+'_rh.grib')

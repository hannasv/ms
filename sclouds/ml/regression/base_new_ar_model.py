...
path_ar_results = '{}/results/ar/models/'.format(lagr_path)
...
if not os.path.exists(path_ar_results):
    os.makedirs(path_ar_results)
    path_ar_results = os.path.join(path_ar_results, full_name)
    if not os.path.exists(os.path.join(path_ar_results, full_name)):
            os.makedirs(os.path.join(path_ar_results, full_name))

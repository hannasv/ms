...
try:
    train_ar_model(transform=True, bias=False, sig=False, order=5, overwrite_results = True) # AR-L0
except OSError:
    #print('ende')
    print('Finished training model ... ')
...
try:
    train_ar_model(transform=False, bias=False, sig=True, order=5, overwrite_results = True) # AR-L0
except OSError:
    #print('ende')
    print('Finished training model ... ')

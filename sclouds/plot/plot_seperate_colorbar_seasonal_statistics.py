    ...
    for var in VARIABLES:
        ...
        for season in SEASONS:
            ...
            try:
                ...
                cntours = axs[counter].contourf(vals,
            ...
            if counter%4==0:
                ...
                fig.colorbar(cntours, ax=axs[counter-1])


    fig.suptitle(stat)
    plt.subplots_adjust(left=0.1, bottom=0.05, right=0.80, top=0.9, hspace=0.1, wspace=0.4)
    plt.savefig(path_python_figures + 'seperate_colorbar_seasonal_{}_all_variables.png'.format(stat))

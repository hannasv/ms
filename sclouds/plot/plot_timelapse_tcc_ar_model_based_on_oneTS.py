...
fil = os.path.join('/home/hanna/MS-thesis/python_figs/','brand_new_prediction3_era5_as_input.nc')
...
plt.savefig(path_python_figures + 'AR_timelapse_cloud_cover_24hrs_from_2014_01_01_base_on_one_hrERA5.png')
